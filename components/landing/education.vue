    ...
    <section class="resume-section spad">
			<div class="container-fluid">
              ...
              <li>
								...
								<h4>KodeHauz Akwa Ibom, Nigeria</h4>
								<p>I learnt HTML, CSS3, Javascript. With consistency and hardwork I was able to build and nurture my skills, and earn a Responsive Design Certificate From Free Code Camp.</p>
							</li>
							<li>
								<h2>2011 - 2016</h2>
